...
/**
 * A browser-safe, in-memory PrivateStateProvider. State does not persist across page reloads —
 * fine for a single deploy session, not a substitute for the encrypted wallet-backed providers
 * used by the CLI.
 */
