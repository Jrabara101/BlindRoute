...
export enum EscrowState { EMPTY = 0, LOCKED = 1, RELEASED = 2 }

export type Witnesses<PS> = {
  localSecretKey(context: __compactRuntime.WitnessContext<Ledger, PS>): [PS, Uint8Array];
  deliveryProof(context: __compactRuntime.WitnessContext<Ledger, PS>): [PS, Uint8Array];
}
...
export type PureCircuits = {
  commitmentOf(proof_0: Uint8Array): Uint8Array;
